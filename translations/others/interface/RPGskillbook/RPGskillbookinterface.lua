...
function changeToSkills()
  widget.setText("tabLabel", "Aba de Habilidades")
  widget.setVisible("skillslayout", true)
end

function changeToLore()
  widget.setText("tabLabel", "Aba de Enredo")
...
function changeToLoreText()
  ...
  widget.setText("lorelayout.title", "Enredo")
  widget.setText("lorelayout.scrollArea.text", "Enredo Não Disponível Ainda")
end
